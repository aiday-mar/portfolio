const projects = [
  ...
  },
  {
    ...
    details: "Built a developer-focused blog platform using Next.js and MDX for rich markdown content with embedded React components. Features include syntax highlighting for code blocks, automatic table of contents generation, SEO metadata management, and a custom content management system backed by Prisma and PostgreSQL. The platform supports draft/published states, tags, and full-text search.",
...
const vscodeProjects = projects.filter((p) => p.category === "vscode");
