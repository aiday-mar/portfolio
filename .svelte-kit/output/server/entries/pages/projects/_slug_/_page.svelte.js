...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--></div> <div class="mb-10 h-64 overflow-hidden rounded-xl bg-gradient-to-br from-purple-50 to-fuchsia-50 dark:from-purple-900/20 dark:to-fuchsia-900/20"><div class="flex h-full items-center justify-center text-6xl text-purple-600/20 dark:text-purple-400/20">&lt;/></div></div> <div class="mb-10"><h2 class="mb-4 text-xl font-semibold text-zinc-900 dark:text-white">About This Project</h2> <p class="leading-relaxed text-zinc-600 dark:text-zinc-400">${escape_html(data.project.details)}</p></div> <div class="flex gap-4"><a${attr("href", data.project.link)} class="inline-flex h-10 items-center justify-center rounded-full bg-purple-600 px-6 text-sm font-medium text-white transition-colors hover:bg-purple-700">Live Demo</a> <a${attr("href", data.project.github)} class="inline-flex h-10 items-center justify-center rounded-full border border-purple-300 px-6 text-sm font-medium text-purple-900 transition-colors hover:bg-purple-50 dark:border-purple-700 dark:text-purple-200 dark:hover:bg-purple-900/30">GitHub</a></div></div></main>`);
  });
}
export {
  _page as default
